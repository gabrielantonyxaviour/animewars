...
task("deploy-encrypted", "Deploys the EncryptedERC20 contract")
  .addOptionalParam(
    "verify",
  ...
  .setAction(async (taskArgs) => {
    console.log(`Deploying EncryptedERC20 contract to ${network.name}`);
    ...
    console.log(
      "\nDeployed EncryptedERC20 contract to:",
    ...
    console.log(
      `\n EncryptedERC20 contract deployed to ${pythTesterContract.address} on ${network.name}`
    );
  });
